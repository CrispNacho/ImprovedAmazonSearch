...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        productScreen.grid.addRow(7, summaryScreenButton1);

        SummaryPage summaryScreen = new SummaryPage();
        summaryScreen.grid.addRow(7, searchScreenButton1);

        //Creating scene objects
        Scene summaryScreenScene = new Scene(summaryScreen.grid,640, 480);
        Scene productScreenScene = new Scene(productScreen.grid, 640, 480);
